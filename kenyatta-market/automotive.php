      ...
      <?php while ($row = $result->fetch_assoc()): ?>
        <div class="bg-white rounded-lg shadow-md overflow-hidden group hover:shadow-lg transition duration-300">
          <div class="relative h-48 overflow-hidden">
            <img
              src="<?= !empty($row['image']) ? htmlspecialchars($row['image']) : 'assets/default-car.jpg' ?>"
          ...
          <div class="p-4 space-y-2">
            ...
            <p class="text-sm text-gray-500">by <?= htmlspecialchars($row['seller'] ?? 'Unknown') ?></p>
